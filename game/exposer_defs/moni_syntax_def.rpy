init python:
    monika_def = ExposerPreviewerDefinition(
        char="monika",
        ...
        specials=['s_scream'],
        second_poses=['lean'],
        second_moods=['happ', 'angr', 'anno', 'neut'],
        ...
        ddlc_expressions = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r'],
        ddlc_special_pose = [5],
        ddlc_special_expressions = ['a', 'b']
    )